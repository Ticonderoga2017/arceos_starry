...
//     }
//     else {
//         printf("Hugepage memory allocated at &p\n", huge_mem);
//     }

//     // 解映射第一个 4KB 的内存
//     if (munmap(huge_mem, 2 * 1024 * 1024 + 4096)== -1) {
//         perror("Failed to unmap 4KB of hugepage memory"),printf("Error:&s\n",strerror(errno));
//     }
//     else {
//         printf("successfully unmapped 4kB of hugepage memory\n");
//     }
//     return 0;
// }